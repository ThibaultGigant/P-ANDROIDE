...
\draw (12,-0.1) node[below] {12};
\draw plot[ultra thick]coordinates{(1,5)(2,4)(3,5)(4,4)(5,4)(6,3)(7,2)(8,1)(9,1)(10,2)(11,2)(12,2)};
\draw[fill=black] (1,5) circle (0.1);
\draw[fill=black] (2,4) circle (0.1);
\draw[fill=black] (3,5) circle (0.1);
\draw[fill=black] (4,4) circle (0.1);
...
\draw[fill=black] (12,2) circle (0.1);
\end{tikzpicture}
\caption{Permutation 2 of Orsay7}
\end{figure}
\begin{figure}
\begin{tikzpicture}[x=\textwidth/13, y=\textwidth/13]
\draw[->, >=latex] (0,0) -- (13,0);
...
\draw[fill=black] (12,2) circle (0.1);
\end{tikzpicture}
\caption{Permutation 3 of Orsay7}
\end{figure}
\end{center}
\clearpage
...
\draw (11,-0.1) node[below] {16};
\draw (12,-0.1) node[below] {12};
\draw plot[ultra thick]coordinates{(1,4)(2,5)(3,5)(4,4)(5,4)(6,3)(7,2)(8,1)(9,2)(10,2)(11,1)(12,2)};
\draw[fill=black] (1,4) circle (0.1);
\draw[fill=black] (2,5) circle (0.1);
\draw[fill=black] (3,5) circle (0.1);
\draw[fill=black] (4,4) circle (0.1);
...
\draw[fill=black] (12,2) circle (0.1);
\end{tikzpicture}
\caption{Permutation 1 of Orsay12}
\end{figure}
\end{center}
\clearpage

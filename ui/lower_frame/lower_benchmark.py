...
class Benchmark(Frame):
    ...
    def display_table(self):
        ...
        if algo == 0:
            ...
            ttk.Separator(self,orient=VERTICAL).grid(row=0, column=12, rowspan=len(self.files)*2+3, padx=10, sticky="ns")
            Label(self, text="Axes trouvés").grid(row=1, column=13)
            ttk.Separator(self,orient=VERTICAL).grid(row=0, column=14, rowspan=len(self.files)*2+3, padx=10, sticky="ns")
            ...
            ttk.Separator(self,orient=VERTICAL).grid(row=0, column=10, rowspan=len(self.files)*2+3, padx=(10,0), sticky="ns")
